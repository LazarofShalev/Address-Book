public interface AddressBookJavaFx1Finals {
	final static int NUMBER_OF_OBJECTS = 3;
	final static String NUMBER_OF_OBJECTS_LE0 = "NUMBER OF OBJECTS <= 0";
	final static String SINGLETON_MESSAGE = "Singelton violation. Only 3 panes were created";
	...
	enum eventType {
		ADD(true), FIRST(true), LAST(true), NEXT(true), PREVIOUS(true), REDO(true), UNDO(true);
